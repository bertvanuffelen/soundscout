...
| A5 | **Álles is een robot**: piraten/bewoners/dieren/monsters zijn robot-versies; géén mensen of echte dieren. **Gezicht = scherm/visor met gloeiende ogen + simpel mondje; géén menselijke mond/tanden/lippen** |
