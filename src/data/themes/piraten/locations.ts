...
export const locations: Location[] = [
  {
    ...
    unlocked: true,
    hotspots: [
      { id: 'grogkroeg-accordeon', x: 78.9, y: 60.7, sampleId: 'grogkroeg-accordeon', visualHint: 'pulse' },
      { id: 'grogkroeg-kroezen', x: 50.7, y: 39.6, sampleId: 'grogkroeg-kroezen', visualHint: 'pulse' },
      { id: 'grogkroeg-papegaai', x: 67.2, y: 18.5, sampleId: 'grogkroeg-papegaai', visualHint: 'pulse' },
      { id: 'grogkroeg-lach', x: 26.9, y: 46.2, sampleId: 'grogkroeg-lach', visualHint: 'pulse' },
      { id: 'grogkroeg-deur', x: 92.6, y: 37.2, sampleId: 'grogkroeg-deur', visualHint: 'pulse' },
      { id: 'grogkroeg-dobbel', x: 60.7, y: 93.8, sampleId: 'grogkroeg-dobbel', visualHint: 'pulse' },
      { id: 'grogkroeg-vat', x: 90.7, y: 71.2, sampleId: 'grogkroeg-vat', visualHint: 'pulse' },
      { id: 'grogkroeg-fluit', x: 79.4, y: 49.3, sampleId: 'grogkroeg-fluit', visualHint: 'pulse' },
    ],
  },
  {
    id: 'haven',
  ...
  },
  {
    ...
    unlocked: true,
    hotspots: [
      { id: 'schip-zeilen', x: 90.2, y: 25.4, sampleId: 'schip-zeilen', visualHint: 'pulse' },
      { id: 'schip-kanon', x: 31, y: 74.5, sampleId: 'schip-kanon', visualHint: 'pulse' },
      { id: 'schip-anker', x: 76.2, y: 88.9, sampleId: 'schip-anker', visualHint: 'pulse' },
      { id: 'schip-zeemanslied', x: 34.9, y: 55, sampleId: 'schip-zeemanslied', visualHint: 'pulse' },
      { id: 'schip-wind', x: 30.7, y: 12.5, sampleId: 'schip-wind', visualHint: 'pulse' },
      { id: 'schip-stuurwiel', x: 26.1, y: 34.1, sampleId: 'schip-stuurwiel', visualHint: 'pulse' },
